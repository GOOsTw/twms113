...
public class BeanGame {
    final static int PACHINKO_MARQUEE = 0x152;
    
    public static MaplePacket marqueeMessage(String playerName)
    {
        MaplePacketLittleEndianWriter writer = new MaplePacketLittleEndianWriter();
        writer.writeShort(PACHINKO_MARQUEE);
        writer.writeInt(1);
...
/*  30: 37 */
            ...
            writer.writeShort(0x154);
            writer.write(0);
            writer.write(0);
            c.sendPacket(writer.getPacket());
            /*
            writer.writeShort(0x152);
            writer.writeInt(1);
            writer.writeMapleAsciiString(chr.getName());
            c.sendPacket(writer.getPacket());
            System.out.println("中獎了？" +slea.toString());
            */
