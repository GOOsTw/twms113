    ...
    public static void main(String args[]) {
        ...
        while (retry1 == 0) {
            try {
                ...
                if (target.contains("kryptodev") || target.contains("destinyms") || target.contains("89.18.189.189") || target.contains("91.214.44.30") || target.contains("69.163.44.74") || target.contains("smexy.myftp.org") || target.contains("211.23.17.211")) {
                    retry1 = 0;
