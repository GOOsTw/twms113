...
public class MapleFamilyBuff {
    ...
    private static final int[] duration = {0, 0, 15, 15, 15, 15, 30, 30, 30, 30};
    private static final int[] effect = {0, 0, 150, 150, 200, 200, 200, 200, 200, 200};
    private static final int[] rep = {0, 0, 300, 500, 800, 1000, 1200, 1500, 2000, 2500}; //70% of normal in gms O_O
