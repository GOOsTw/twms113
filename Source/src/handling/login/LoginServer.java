...
public class LoginServer {
    ...
    public static final void setup() {
        try {
            ...
            System.out.println("【登入伺服器】 登入伺服器端口: " + Short.toString(PORT) + " \n");
    ...
    public static final void shutdown() {
        if (finishedShutdown) {
            System.out.println("【登入伺服器】 登入伺服器已經關閉了...無法執行此動作");
            return;
        }
        System.out.println("【登入伺服器】 登入伺服器關閉中...");
        ...
        System.out.println("【登入伺服器】 登入伺服器關閉完畢...");
