...
function action(mode, type, selection) {
	...
	if (cm.getJob() == 510 || cm.getJob() == 520) {
		...
		status = 35;
		cm.sendNext("Okay, as promised, you will now become a #b打手#k.");
	    } else if (cm.getQuestStatus(2192) == 2) {
		status = 40;
		cm.sendNext("Okay, as promised, you will now become a #b槍手#k.");
